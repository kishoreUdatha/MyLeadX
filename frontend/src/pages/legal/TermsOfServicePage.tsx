          ...
          <section className="mb-12">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 leading-relaxed mb-2">
                The MyLeadX service is owned and operated by:
              </p>
              <ul className="list-none pl-0 text-gray-600 space-y-1">
                ...
                <li>Email: <a href="mailto:support@myleadx.ai" className="text-amber-700 hover:underline">support@myleadx.ai</a></li>
              </ul>
              <p className="text-gray-500 text-sm mt-4">
                References to "MyLeadX," "Company," "we," "our," or "us" in these Terms refer to SMARTGROW INFOTECH PRIVATE LIMITED.
              </p>
            </div>
          </section>
