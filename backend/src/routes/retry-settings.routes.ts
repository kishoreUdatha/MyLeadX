...
router.put(
  ...
  validate([
    ...
    body('callRetryInterval').optional().isInt({ min: 15, max: 1440 }),
    body('callRetryStartTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    body('callRetryEndTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    ...
    body('whatsappRetryInterval').optional().isInt({ min: 30, max: 1440 }),
    body('whatsappRetryStartTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    body('whatsappRetryEndTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    body('smsRetryEnabled').optional().isBoolean(),
    body('smsMaxAttempts').optional().isInt({ min: 1, max: 10 }),
    body('smsRetryInterval').optional().isInt({ min: 30, max: 1440 }),
    body('smsRetryStartTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    body('smsRetryEndTime').optional().matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/),
    body('emailRetryEnabled').optional().isBoolean(),
    body('emailMaxAttempts').optional().isInt({ min: 1, max: 10 }),
    body('emailRetryInterval').optional().isInt({ min: 30, max: 1440 }),
