...
import platformProspectRoutes from './platform-prospect.routes';
import platformAnalyticsRoutes from './platform-analytics.routes';
import platformWebhooksRoutes from './platform-webhooks.routes';
...
import messagingCreditsRoutes from './messaging-credits.routes';
import messagingPortalRoutes from './messaging-portal.routes';
...
router.use('/platform-prospects', platformProspectRoutes);
router.use('/platform-analytics', platformAnalyticsRoutes);
router.use('/platform-webhooks', platformWebhooksRoutes);
...
router.use('/messaging-credits', messagingCreditsRoutes);
router.use('/messaging-portal', messagingPortalRoutes);
